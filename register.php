...
<body class="hold-transition register-page custom-register">
  <script>
    start_loader()
  </script>
  <style>
   ...
   body{
  background: url("<?php echo base_url ?>assets/img/school_background.jpg") no-repeat center center fixed !important;
...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        <center><img src="<?php echo base_url ?>assets/img/school_logo.png" alt="School Logo" id="logo-img">
</center>
        <h1 class="text-center py-5 login-title text-white"><b><?php echo $_settings->info('name') ?> </b></h1>
      </div>
        ...
        <div class="w-100 d-flex justify-content-center align-items-center h-100 text-navy">
            <div class="card card-outline card-success rounded-0 shadow col-lg-10 col-md-10 col-sm-5">
                <div class="card-header">
                    <h5 class="card-title text-center text-black"><b>Registration</b></h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <button class="btn btn-default bg-green btn-flat"> Register</button>
                                </div>
                            </div>
                        </div>
                    </form>
